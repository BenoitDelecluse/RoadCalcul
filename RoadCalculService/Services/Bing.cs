...
namespace RoadCalculServiceTest.Services
{
    public static class Bing
    {
        ...
        public static async Task<List<Location>> GetLocationAsync(string querrylocation)
        {
            //Create a request.
        ...
        public static async Task<List<DistanceMatrix>> DistanceMatrixAsync(RoadCalculModel.Route criteira)
        {
            //Create a request.
